...
- Recommendation: pre_phone_preparation_current_phone_deferred
...
| 5 | blocked | Run final Android phone evidence lane | `RUN_PHONE=1 data/runs/20260528_voice_direction_mvp/93-hardware-test-operator-pack/commands.sh` | authorized ADB devices must be exactly 1, current=0 |
