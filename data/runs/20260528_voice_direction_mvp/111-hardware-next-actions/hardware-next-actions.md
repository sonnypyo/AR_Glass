...
| 3 | blocked | Prepare glasses evidence lane | `RUN_GLASSES=1 data/runs/20260528_voice_direction_mvp/93-hardware-test-operator-pack/commands.sh` | Meta application id missing; GitHub Packages token missing; glasses preflight blocked=3; real Android XR projected contract not ready; glasses private alpha candidate false |
