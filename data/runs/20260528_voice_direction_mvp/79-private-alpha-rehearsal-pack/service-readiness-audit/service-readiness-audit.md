...
Generated: 2026-05-28T08:12:15+09:00
...
18. Add Meta DAT credentials outside source control and rerun `scripts/glasses-integration-preflight.sh --write-evidence`.
19. Replace stub glasses adapters one platform at a time only after preflight blockers close.
20. Keep this audit report with the run artifacts after every phone/glasses/support session.
