...
Generated: 2026-05-28T10:24:03+09:00
...
30. Add Meta DAT credentials outside source control and rerun `scripts/glasses-integration-preflight.sh --write-evidence`.
31. Replace stub glasses adapters one platform at a time only after preflight blockers close.
32. Keep this audit report with the run artifacts after every phone/glasses/support session.
